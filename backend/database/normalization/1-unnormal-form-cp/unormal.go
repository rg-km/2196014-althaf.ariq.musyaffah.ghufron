...
func Migrate() (*sql.DB, error) {
	...
	_, err = db.Exec(`
	INSERT INTO unormal (no_bon, nama_barang, harga, jumlah, biaya, sub_total, discount, total, bayar, kembalian, kasir, tanggal, waktu)
	VALUES 
	...
	("00002", "Disket,Mouse,Flash Disk", "4500,17500,100000", "1,1,1", "4500,17500,100000", 122000, 0, 122000, 122000, 0, "Dewi", "04-05-2022", "12:00:00");`) // TODO: replace this
