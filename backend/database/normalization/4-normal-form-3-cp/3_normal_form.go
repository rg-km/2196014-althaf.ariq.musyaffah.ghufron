...
func Migrate() (*sql.DB, error) {
	...
	_, err = db.Exec(`INSERT INTO rekap_detail (
		no_bon, kode_barang, harga, jumlah
	) VALUES 
		("00001", "B001", 4500, 3),
		("00001", "B002", 22500, 1),
		("00001", "B003", 1500, 4),
...
func checkBarangExists(kodeBarang string) (bool, error) {
	...
	sqlStmt := `SELECT COUNT(*) FROM barang` // TODO: replace this
...
func checkKasirExists(kodeKasir string) (bool, error) {
	...
	sqlStmt := `SELECT COUNT(*) FROM kasir` // TODO: replace this
